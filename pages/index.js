...
export default function Home() {
  ...
  return (
    <>
      ...
      alt= "Met Building"
      fluid rounded></img><br /><br /></Col></Row>
      ...
      The Metropolitan Museum of Art was founded in 1870 with its
        ...
        The museum&apos;s permanent collection consists of works of art from
        ...
        of African, Asian, Oceanian, Byzantine, and Islamic art. The museum
        is home to encyclopedic collections of musical instruments,
        ...
        most-visited art museums in the world. </p>
        <p>
        <a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art"
        target="_blank" rel="noreferrer">https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art</a></p>
          </Col>
          </Row>
      </>
  )
